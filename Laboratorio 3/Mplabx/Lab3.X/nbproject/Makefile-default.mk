...
SOURCEFILES_QUOTED_IF_SPACED=adc.c LCD.c INT.c CONFIG.c confb.c EUSCON.c Lab3.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/adc.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/INT.p1 ${OBJECTDIR}/CONFIG.p1 ${OBJECTDIR}/confb.p1 ${OBJECTDIR}/EUSCON.p1 ${OBJECTDIR}/Lab3.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/INT.p1.d ${OBJECTDIR}/CONFIG.p1.d ${OBJECTDIR}/confb.p1.d ${OBJECTDIR}/EUSCON.p1.d ${OBJECTDIR}/Lab3.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/adc.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/INT.p1 ${OBJECTDIR}/CONFIG.p1 ${OBJECTDIR}/confb.p1 ${OBJECTDIR}/EUSCON.p1 ${OBJECTDIR}/Lab3.p1

# Source Files
SOURCEFILES=adc.c LCD.c INT.c CONFIG.c confb.c EUSCON.c Lab3.c
...
${OBJECTDIR}/confb.p1: confb.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/confb.p1 confb.c 
